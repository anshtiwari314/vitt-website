$(document).ready(function() {
    ...
    subscribeButton.click(function(e) {
        ...
        var post_data = {
          ...
          $.ajax({
      type: 'POST',
      url: 'https://portal.vitt.ai/api/subscribemail',
      ...
      success: function(response){
          ...
          if(response.type == 'error') {
              ...
              subscribeAlertMessage.html('<p><i class="fa fa-times-circle"></i> ' + response.status + '</p>');
      ...
      dataType: 'json'
        ...
        // $.post('https://portal.vitt.ai/api/subscribemail', post_data,
        // function(response){
        //
        //
        //     // Load jsn data from server and output message
